      ...
      <article
        ...
        className={`group relative flex h-full w-full max-w-xl flex-col gap-5 rounded-3xl border p-6 shadow-xl transition hover:-translate-y-1 mx-auto ${
          isResolvable
            ...
            : "border-amber-200/[0.350] bg-[radial-gradient(circle_at_top,rgba(245,158,11,0.09),rgba(2,6,23,0.95)_70%)] shadow-amber-500/[0.245] hover:border-amber-200/[0.283] hover:shadow-amber-400/[0.367]"
      } ${
        voted
          ? isResolvable
